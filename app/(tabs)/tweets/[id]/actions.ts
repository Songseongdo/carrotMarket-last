...
export const getCachedtweetInfo = NextCache(async (id: number) => getTweetInfo(id), ["tweet-info"], {
	tags: ["tweets"],
	revalidate: 30,
});
export const getCachedtweetUserInfo = NextCache(async (id: number) => getTweetUserInfo(id), ["tweet-userinfo"], {
	tags: ["tweets"],
	revalidate: 30,
});
